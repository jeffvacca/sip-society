            ...
            <div className="w-11/12 lg:w-9/12 px-4">
                ...
                <div className="md:grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-6 font-didact text-dark lg:text-lg flex flex-col justify-center md:text-right">
                        <p>With years of experience in both high-end venues and casual settings, I am dedicated to providing a fun, professional, and stress-free bar experience, leaving you free to enjoy the celebration. Let me handle the drinks, so you can focus on making memories!</p>
                    </div>
                </div>
            </div>
        </div>
